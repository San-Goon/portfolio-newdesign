...
import food_delivery from '../../public/food_delivery.jpg';
import checkpoint from '../../public/checkpoint.jpg';
import incourserun from '../../public/incourserun.png';
...
const Card = ({ image, title, repo, link }: CardProps) => {
...
const favProjects = [
  {
    image: checkpoint,
    title: 'LOA Checker(In development)',
  ...
  {
    image: incourserun,
    title: 'In-course commerce',
    repo: 'https://github.com/San-Goon/e-commerce-project',
    link: 'https://fastcampas-5-commerce-fe-nwm6.vercel.app/'
  },
  {
    image: stauter,
    title: 'Stauter',
    link: 'https://www.stauter.co.kr/'
  },
  {
    image: food_delivery,
  ...
  },
  {
    image: dafalza,
    title: '다팔자',
    link: 'https://ownerclan.com/V2/info_page/dafalza2.php'
  }
];
