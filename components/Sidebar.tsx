...
const Sidebar = () => {
	return (
		<div>
			...
			<a className="flex items-center justify-center px-2 py-1 my-3 bg-gray-200 rounded-full" href="" target="_blank" rel="noreferrer noopenner">
				<GiTie className="w-6 h-6"/>이력서 다운로드
			</a>
			...
			<button className='bg-gradient-to-r from-green-400 to-blue-400 w-8/12 rounded-full py-2 px-5 text-white my-2'>Theme</button>
		</div>
	)
}
